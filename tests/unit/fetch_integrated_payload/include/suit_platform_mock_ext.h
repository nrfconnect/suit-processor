 ...
 *  - __wrap_<API>_ExpectArgsAndReturn(args..): that compare directly the values with the expected arguments
 *  - __wrap_<API>_ExpectWithArrayAndReturn(args.., *args..): that compare pointer arguments against an expected, pointed memory contents
 *
 ...
 *  - __wrap_<API>_ExpectArgsAndReturn(args..): will assert on the pointer to the structure,
 *    which usually points to the local variable, thus the address is unpredictable.
 *  - __wrap_<API>_ExpectWithArrayAndReturn(args.., *args..): will correctly verify the `len` field,
 ...
 *
 * To mix complex and non-complex argument types, the regular __wrap_<API>_ExpectArgsAndReturn(args..)
 * functions are used, but for each complex argument:
 *  - The queue is populated
 *  - The __wrap_<API>_IgnoreArg_<complex_arg_name> API is called
 * In addition to that:
...
#define __wrap_suit_plat_check_digest_ExpectComplexArgsAndReturn(alg_id, digest, payload, cmock_retval) { \
	...
	__wrap_suit_plat_check_digest_AddCallback(__check_digest_callback); \
	__wrap_suit_plat_check_digest_ExpectAndReturn(alg_id, digest, payload, cmock_retval); \
	__wrap_suit_plat_check_digest_IgnoreArg_digest(); \
	__wrap_suit_plat_check_digest_IgnoreArg_payload(); \
}
...
#define __wrap_suit_plat_authenticate_ExpectComplexArgsAndReturn(alg_id, key_id, signature, data, cmock_retval) { \
	extern complex_arg_q_t __authenticate_callback_queue; \
	push_complex_arg(key_id, assert_zcbor_string, __authenticate_callback_queue); \
	push_complex_arg(signature, assert_zcbor_string, __authenticate_callback_queue); \
	push_complex_arg(data, assert_zcbor_string, __authenticate_callback_queue); \
	push_retval_arg(cmock_retval, __authenticate_callback_queue); \
	__wrap_suit_plat_authenticate_AddCallback(__authenticate_callback); \
	__wrap_suit_plat_authenticate_ExpectAndReturn(alg_id, key_id, signature, data, cmock_retval); \
	__wrap_suit_plat_authenticate_IgnoreArg_key_id(); \
	__wrap_suit_plat_authenticate_IgnoreArg_signature(); \
	__wrap_suit_plat_authenticate_IgnoreArg_data(); \
}
...
#define __wrap_suit_plat_check_image_match_ExpectComplexArgsAndReturn(alg_id, digest, image_size, image_handle, cmock_retval) { \
	...
	__wrap_suit_plat_check_image_match_AddCallback(__check_image_match_callback); \
	__wrap_suit_plat_check_image_match_ExpectAndReturn(alg_id, digest, image_size, image_handle, cmock_retval); \
	__wrap_suit_plat_check_image_match_IgnoreArg_digest(); \
}
...
#define __wrap_suit_plat_check_vid_ExpectComplexArgsAndReturn(vid_uuid, component_handle, cmock_retval) { \
	...
	__wrap_suit_plat_check_vid_AddCallback(__check_vid_callback); \
	__wrap_suit_plat_check_vid_ExpectAndReturn(vid_uuid, component_handle, cmock_retval); \
...
#define __wrap_suit_plat_check_cid_ExpectComplexArgsAndReturn(cid_uuid, component_handle, cmock_retval) { \
	...
	__wrap_suit_plat_check_cid_AddCallback(__check_cid_callback); \
	__wrap_suit_plat_check_cid_ExpectAndReturn(cid_uuid, component_handle, cmock_retval); \
	__wrap_suit_plat_check_cid_IgnoreArg_cid_uuid(); \
}
int __check_cid_callback(struct zcbor_string* cid_uuid, suit_component_t component_handle, int cmock_num_calls);

#define __wrap_suit_plat_check_did_ExpectComplexArgsAndReturn(did_uuid, component_handle, cmock_retval) { \
	...
	__wrap_suit_plat_check_did_AddCallback(__check_did_callback); \
	__wrap_suit_plat_check_did_ExpectAndReturn(did_uuid, component_handle, cmock_retval); \
	__wrap_suit_plat_check_did_IgnoreArg_did_uuid(); \
}
int __check_did_callback(struct zcbor_string* did_uuid, suit_component_t component_handle, int cmock_num_calls);

#define __wrap_suit_plat_check_fetch_integrated_ExpectComplexArgsAndReturn(dst_handle, payload, cmock_retval) { \
	...
	__wrap_suit_plat_check_fetch_integrated_AddCallback(__check_fetch_integrated_callback); \
	__wrap_suit_plat_check_fetch_integrated_ExpectAndReturn(dst_handle, payload, cmock_retval); \
	__wrap_suit_plat_check_fetch_integrated_IgnoreArg_payload(); \
}
int __check_fetch_integrated_callback(suit_component_t dst_handle, struct zcbor_string* payload, int cmock_num_calls);

#define __wrap_suit_plat_fetch_integrated_ExpectComplexArgsAndReturn(dst_handle, payload, cmock_retval) { \
	...
	__wrap_suit_plat_fetch_integrated_AddCallback(__fetch_integrated_callback); \
	__wrap_suit_plat_fetch_integrated_ExpectAndReturn(dst_handle, payload, cmock_retval); \
	__wrap_suit_plat_fetch_integrated_IgnoreArg_payload(); \
}
