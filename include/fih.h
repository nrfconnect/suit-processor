 ...
 * separately or by defining one of the SUIT_FIH_PROFILEs.
 *
...
#if defined(SUIT_FIH_PROFILE_LOW)
#define FIH_ENABLE_GLOBAL_FAIL
#define FIH_ENABLE_CFI

#elif defined(SUIT_FIH_PROFILE_MEDIUM)
#define FIH_ENABLE_DOUBLE_VARS
#define FIH_ENABLE_GLOBAL_FAIL
#define FIH_ENABLE_CFI

#elif defined(SUIT_FIH_PROFILE_HIGH)
